...
struct UsagePaceTextTests {
    ...
    func `usage pace text localization keys exist in en and zh Hans with matching placeholders`() throws {
        ...
        let enURL = root.appendingPathComponent("Sources/Usager/Resources/en.lproj/Localizable.strings")
        let zhURL = root.appendingPathComponent("Sources/Usager/Resources/zh-Hans.lproj/Localizable.strings")
