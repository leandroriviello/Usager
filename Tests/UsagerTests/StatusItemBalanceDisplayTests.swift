...
struct StatusItemBalanceDisplayTests {
    ...
    func `debug bundle identity updates status item accessibility`() {
        #expect(StatusItemController.isDebugApp(bundleIdentifier: "com.leandroriviello.usager.debug"))
        #expect(!StatusItemController.isDebugApp(bundleIdentifier: "com.leandroriviello.usager"))
        #expect(!StatusItemController.isDebugApp(bundleIdentifier: nil))
        #expect(StatusItemController.statusItemAccessibilityTitle(isDebugApp: true) == "Usager Debug")
        #expect(StatusItemController.statusItemAccessibilityTitle(isDebugApp: false) == "Usager")
    }
