...
struct LocalizationBundleTests {
    ...
    func `packaged app resolves localization bundle from resources`() throws {
        ...
        #expect(bundle.bundleURL.lastPathComponent == "Usager_Usager.bundle")
        ...
        includeEmptyChineseLocalization: Bool = false) throws -> (root: URL, appBundle: Bundle)
    {
        let root = FileManager.default.temporaryDirectory.appendingPathComponent(
            "usager-localization-\(UUID().uuidString)",
            isDirectory: true)
        ...
        <plist version="1.0">
        <dict>
            <key>CFBundleExecutable</key><string>Usager</string>
            <key>CFBundleIdentifier</key><string>com.leandroriviello.usager.tests</string>
            <key>CFBundleName</key><string>Usager</string>
        ...
        if includeLocalizationBundle {
            let bundleURL = resourcesURL.appendingPathComponent("Usager_Usager.bundle", isDirectory: true)
