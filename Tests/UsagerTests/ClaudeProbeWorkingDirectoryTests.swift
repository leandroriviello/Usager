...
struct ClaudeProbeWorkingDirectoryTests {
    ...
    func `probe project directory name matches Claude Code encoding`() {
        let cases = [
            (
                "/Users/test/Library/Application Support/Usager/ClaudeProbe",
                "-Users-test-Library-Application-Support-Usager-ClaudeProbe"),
            (
                "/Users/test.name/t\u{00E9}st_under/Library/Application Support/Usager/ClaudeProbe",
                "-Users-test-name-t-st-under-Library-Application-Support-Usager-ClaudeProbe"),
            (
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("usager-claude-probe-\(UUID().uuidString)", isDirectory: true)
