...
@testable import UsagerWidget

struct UsagerWidgetProviderTests {
    @Test
    ...
    func `supported providers fall back to codex when snapshot is empty`() {
        ...
        #expect(UsagerSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.codex])
    }
    ...
    func `supported providers keep alibaba when it is the only enabled provider`() {
        ...
        #expect(UsagerSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.alibaba])
    }
    ...
    func `supported providers keep alibaba token plan when it is the only enabled provider`() {
        ...
        #expect(UsagerSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.alibabatokenplan])
    }
    ...
    func `supported providers keep Mistral when it is the only enabled provider`() {
        ...
        #expect(UsagerSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.mistral])
    }
    ...
    func `supported providers keep Kimi when it is the only enabled provider`() {
        ...
        #expect(UsagerSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.kimi])
    }
...
extension UsagerWidgetProviderTests {
    @Test
