...
struct OpenAIDashboardWebViewCacheTests {
    ...
    func `Reused page reset clears one shot scraper globals`() async throws {
        ...
        _ = try await lease.webView.evaluateJavaScript(
            ...
            window.__usagerUsageBreakdownJSON = '[{"day":"2026-04-19"}]';
            window.__usagerUsageBreakdownDebug = 'debug';
            true;
            """)
        ...
        let reset = try await lease.webView.evaluateJavaScript(
            """
            typeof window.__usagerDidScrollToCredits === 'undefined' &&
            typeof window.__usagerUsageBreakdownJSON === 'undefined' &&
            typeof window.__usagerUsageBreakdownDebug === 'undefined'
            """) as? Bool
