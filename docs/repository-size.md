...
The checked-out source tree is not the main cause of Usager's clone size. At commit `61ff9320`, tracked files total
...
| `Quotio/` | 23,141,837 |
| `Usager 2.app/` | 7,088,125 |
| `Usager-0.2.2.zip` | 2,296,323 |
