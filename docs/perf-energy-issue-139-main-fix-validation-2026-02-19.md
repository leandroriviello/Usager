...
read_when:
  ...
  - Investigating Usager CPU exposure under failed CLI probes
---

# Usager Issue #139 Main Fix Validation (Post-Fix vs Pre-Fix)

Date: 2026-02-19
Workspace: /Users/michalkrsik/windsurf_project_folder/Usager
Branch: codex/perf-issue-139

Reference pre-fix report:
- /Users/michalkrsik/windsurf_project_folder/Usager/docs/perf-energy-issue-139-simulation-report-2026-02-19.md

## Implemented Main Fix

File changed:
- /Users/michalkrsik/windsurf_project_folder/Usager/Sources/UsagerCore/Providers/Codex/CodexStatusProbe.swift
...
- Command run (3 times):
  - `./.build/debug/UsagerCLI usage --provider codex --source cli --format json --pretty`
- Collected:
...
Artifacts:
- /tmp/usager_main_fix_validation_after
