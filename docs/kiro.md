...
1) **CLI command** (primary and only strategy)
   ...
   - Output is ANSI-decorated; Usager strips escape sequences before parsing.
...
- `Sources/UsagerCore/Providers/Kiro/KiroProviderDescriptor.swift`
- `Sources/UsagerCore/Providers/Kiro/KiroStatusProbe.swift`
- `Sources/Usager/Providers/Kiro/KiroProviderImplementation.swift`
