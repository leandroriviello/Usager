...
flowchart TD
    ...
    I --> J{"Refresh status"}
    J -- "200" --> K["Save refreshed creds to Usager keychain cache + memory"]
...
```mermaid
flowchart TD
    A["load(...)"] --> B["Environment token (USAGER_CLAUDE_OAUTH_TOKEN)"]
    B -->|miss| C["Memory cache (valid + unexpired)"]
    C -->|miss| D["Usager keychain cache: com.leandroriviello.usager.cache/oauth.claude"]
...
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/Providers/Claude/ClaudeUsageFetcher.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/Providers/Claude/ClaudeProviderDescriptor.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthCredentials.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthKeychainAccessGate.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthRefreshFailureGate.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/KeychainAccessPreflight.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/KeychainNoUIQuery.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/BrowserCookieImportOrder.swift`
- `/Users/ratulsarna/Developer/staipete/Usager/Sources/UsagerCore/BrowserCookieAccessGate.swift`
