...
- ✅ Adapting concepts to Usager conventions
...
// Implemented using SwiftUI and Usager's UsageStore
```
...
// Implemented using Swift concurrency and Usager's keychain utilities
```
...
- [How quotio differs from Usager]
- [Pros and cons of each approach]
- [What we can learn]

### Implementation Ideas
- [Ideas sparked by quotio]
- [How to adapt to Usager]
...
Implemented independently using Usager patterns and conventions.
```
