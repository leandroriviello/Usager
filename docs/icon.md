---
summary: "Convert macOS .icon bundles to Usager .icns via Scripts/build_icon.sh and ictool."
read_when:
  - Updating the Usager app icon or asset pipeline
...
## Script
`Scripts/build_icon.sh ICON.icon Usager [outdir]`
