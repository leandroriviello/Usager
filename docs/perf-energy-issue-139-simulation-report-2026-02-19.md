...
Artifacts:
- /tmp/usager_perf_sim/results_20260219_111607
...
Artifacts:
- /tmp/usager_perf_sim/energy2_results_20260219_112350
...
- These were controlled simulations, not a full end-user UI replay of `Usager.app` with all real auth/cookie/account paths.
