...
extension UsagerCLI {
    ...
    static func configSettingAPIKey(
        _ config: UsagerConfig,
        provider: UsageProvider,
        apiKey: String,
        enableProvider: Bool,
        accountOptions: ConfigAPIKeyAccountOptions? = nil) -> UsagerConfig
    {
    ...
    static func configProviderStatuses(_ config: UsagerConfig) -> [ConfigProviderStatusResult] {
