...
extension SettingsStore {
    ...
    func reloadTokenAccounts() {
        let log = UsagerLog.logger(LogCategories.tokenAccounts)
    ...
    func openTokenAccountsFile() {
        do {
            ...
            UsagerLog.logger(LogCategories.tokenAccounts).error("Failed to persist config: \(error)")
            return
        }
        ...
        removedCredentials: AntigravityOAuthCredentials)
    {
        do {
            ...
            UsagerLog.logger(LogCategories.tokenAccounts).warning(
