...
enum UsagerLocalizationOverride {
...
private func appLanguageDefaults() -> UserDefaults {
    ...
    return UserDefaults(suiteName: "Usager") ?? .standard
}
...
private func resolvedAppLanguage() -> String {
    if let override = UsagerLocalizationOverride.appLanguage {
        return override
    }
...
func codexBarLocalizationResourceBundle(
    ...
    bundleName: String = "Usager_Usager") -> Bundle
{
    ...
    guard mainBundle === Bundle.main, bundleName == "Usager_Usager" else {
...
func resetUsagerLocalizationCache() {
...
func resetUsagerLocalizationCacheForTesting() {
