        ...
        ScrollView(.vertical, showsIndicators: true) {
            VStack(alignment: .leading, spacing: 20) {
                SettingsSection(title: L("section_logging")) {
                    ...
                    HStack(alignment: .center, spacing: 12) {
                        ...
                        Picker(L("Verbosity"), selection: self.$settings.debugLogLevel) {
                            ForEach(UsagerLog.Level.allCases) { level in
                    ...
                    Button {
                        NSWorkspace.shared.open(UsagerLog.fileLogURL)
                    } label: {
                    ...
                    caption: L("loading_animations_caption"))
                {
                    ...
                    Button {
                        NotificationCenter.default.post(name: .usagerDebugBlinkNow, object: nil)
                    } label: {
