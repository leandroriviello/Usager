...
final class ProviderSwitcherView: NSView {
        ...
        onSettings: (() -> Void)? = nil)
    {
        ...
        let height = Self.overviewSwitcherHeight(
            isOverview: self.overviewPresentation,
        ...
        self.installOverviewHeaderIfNeeded(self.overviewPresentation)
        if width > 0 {
            self.preferredWidth = width
