...
enum KeychainMigration {
    private static let log = UsagerLog.logger(LogCategories.keychainMigration)
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.leandroriviello.Usager", account: "codex-cookie"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "claude-cookie"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "cursor-cookie"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "factory-cookie"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "minimax-cookie"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "minimax-api-token"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "augment-cookie"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "copilot-api-token"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "zai-api-token"),
        MigrationItem(service: "com.leandroriviello.Usager", account: "synthetic-api-key"),
    ]
