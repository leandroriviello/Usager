...
extension UsageStore {
        ...
        observation: LimitResetObservation?)
    {
        ...
        UsagerLog.logger(LogCategories.confetti).info(
        ...
        case .session:
            ...
            NotificationCenter.default.post(name: .usagerSessionLimitReset, object: event)
        case .weekly:
            let event = WeeklyLimitResetEvent(
                ...
                accountLabel: accountLabel,
                usedPercent: currentUsed)
            NotificationCenter.default.post(name: .usagerWeeklyLimitReset, object: event)
        default:
            return
        }
    }
        ...
        logName: String) -> [String: LimitResetDetectorState]
    {
        ...
        do {
            ...
            UsagerLog.logger(LogCategories.confetti).error(
