...
final class MainThreadHangWatchdog: @unchecked Sendable {
    ...
    static let isEnabledForCurrentProcess: Bool = {
        ...
        return environment["USAGER_MAIN_THREAD_HANG_WATCHDOG"] == "1" ||
            UserDefaults.standard.bool(forKey: "debugMainThreadHangWatchdog")
        #endif
    }()

    private let logger = UsagerLog.logger(LogCategories.app)
    ...
    func start() {
        ...
        thread.name = "Usager.MainThreadHangWatchdog"
    ...
    private func launchSample() -> String? {
        let directory = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Logs/Usager", isDirectory: true)
        do {
