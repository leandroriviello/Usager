...
public enum SubprocessRunnerError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        ...
        case let .binaryNotFound(binary):
            return "Missing CLI '\(binary)'. Install it and restart Usager."
...
public enum SubprocessRunner {
    private static let log = UsagerLog.logger(LogCategories.subprocess)
    private static let timeoutQueue = DispatchQueue(
        label: "com.leandroriviello.usager.subprocess.timeout",
        qos: .userInitiated,
