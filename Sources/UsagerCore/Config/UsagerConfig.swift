...
public struct UsagerConfig: Codable, Sendable {
    ...
    public static func makeDefault(
        metadata: [UsageProvider: ProviderMetadata] = ProviderDescriptorRegistry.metadata) -> UsagerConfig
    {
        ...
        return UsagerConfig(version: Self.currentVersion, providers: providers)
    }
