...
public enum UsagerConfigIssueSeverity: String, Codable, Sendable {
    case warning
    case error
}

public struct UsagerConfigIssue: Codable, Sendable, Equatable {
    public let severity: UsagerConfigIssueSeverity
    ...
    public init(
        severity: UsagerConfigIssueSeverity,
...
public enum UsagerConfigValidator {
    ...
    public static func validate(_ config: UsagerConfig) -> [UsagerConfigIssue] {
        var issues: [UsagerConfigIssue] = []

        if config.version != UsagerConfig.currentVersion {
            issues.append(UsagerConfigIssue(
                severity: .error,
                provider: nil,
                field: "version",
    ...
    private static func validateProvider(_ entry: ProviderConfig, issues: inout [UsagerConfigIssue]) {
    ...
    private static func validateSecretKey(_ entry: ProviderConfig, issues: inout [UsagerConfigIssue]) {
    ...
    private static func validateZaiTeamContext(_ entry: ProviderConfig, issues: inout [UsagerConfigIssue]) {
    ...
    private static func zaiMissingTeamContextIssue(field: String) -> UsagerConfigIssue {
        UsagerConfigIssue(
            severity: .warning,
            provider: .zai,
            field: field,
    ...
    private static func validateRegion(_ entry: ProviderConfig, issues: inout [UsagerConfigIssue]) {
        let provider = entry.id
    ...
    private static func validateKnownRegion(
        ...
        isValid: Bool,
        displayName: String,
        issues: inout [UsagerConfigIssue])
    {
