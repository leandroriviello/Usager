...
public enum AppGroupSupport {
    ...
    public static let teamIDInfoKey = "UsagerTeamID"
    public static let legacyReleaseGroupID = "group.com.leandroriviello.usager"
    public static let legacyDebugGroupID = "group.com.leandroriviello.usager.debug"
    ...
    static func currentGroupID(teamID: String, bundleID: String?) -> String {
        let base = "\(teamID).com.leandroriviello.usager"
        ...
        -> URL
    {
        ...
        let directory = base.appendingPathComponent("Usager", isDirectory: true)
