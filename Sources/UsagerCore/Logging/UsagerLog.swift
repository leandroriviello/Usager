...
public enum UsagerLog {
    ...
    public static func logger(_ category: String) -> UsagerLogger {
        let logger = Logger(label: "com.leandroriviello.usager.\(category)")
        return UsagerLogger(isEnabled: { level in
...
public struct UsagerLogger: Sendable {
    private let isEnabled: @Sendable (UsagerLog.Level) -> Bool
    private let logFn: @Sendable (UsagerLog.Level, String, [String: String]?) -> Void

    fileprivate init(
        isEnabled: @escaping @Sendable (UsagerLog.Level) -> Bool,
        log: @escaping @Sendable (UsagerLog.Level, String, [String: String]?) -> Void)
    {
