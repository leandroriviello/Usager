...
public enum ElevenLabsUsageError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingCredentials:
            "Missing ElevenLabs API key. Set apiKey in ~/.usager/config.json or ELEVENLABS_API_KEY."
...
public struct ElevenLabsUsageFetcher: Sendable {
    private static let log = UsagerLog.logger(LogCategories.elevenLabsUsage)
