...
struct AlibabaTokenPlanCookieHeaders {
    private static let cachedAPIHeaderName = "__usager_alibaba_token_plan_api"
    private static let cachedDashboardHeaderName = "__usager_alibaba_token_plan_dashboard"
