...
public struct ClaudeOAuthCredentials: Sendable {
    ...
    private static func makeHistoryOwnerIdentifier(secretKind: String, secret: String) -> String? {
        let material = Data("usager:claude-oauth-history-owner:v1\0\(secretKind)\0\(secret)".utf8)
    ...
    public var errorDescription: String? {
        ...
        case .mcpOAuthOnlyKeychain:
            return "Claude keychain contains MCP OAuth state only (no claudeAiOauth). "
                ...
                + "Open the Usager menu and click Refresh to re-authenticate, "
        ...
        case let .keychainError(status):
            ...
            {
                return "Claude Keychain access was denied. Usager will back off in the background until you retry "
