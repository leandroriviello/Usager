...
public enum ZedStatusProbeError: LocalizedError, Sendable, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .keychainUnavailable:
            "Could not read Zed credentials from the Keychain. Grant Usager Keychain access or sign in to Zed again."
...
public struct ZedStatusProbe: Sendable {
    ...
    private static let logger = UsagerLog.logger(LogCategories.zed)
