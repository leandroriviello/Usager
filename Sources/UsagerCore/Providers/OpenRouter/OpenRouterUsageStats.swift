...
public struct OpenRouterUsageFetcher: Sendable {
    private static let log = UsagerLog.logger(LogCategories.openRouterUsage)
    ...
    private static let debugFullErrorBodiesEnvKey = "USAGER_DEBUG_OPENROUTER_ERROR_BODIES"
    private static let httpRefererEnvKey = "OPENROUTER_HTTP_REFERER"
    private static let clientTitleEnvKey = "OPENROUTER_X_TITLE"
    private static let defaultClientTitle = "Usager"
