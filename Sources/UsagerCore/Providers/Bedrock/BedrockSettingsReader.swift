...
public enum BedrockSettingsReader {
    ...
    public static let budgetKey = "USAGER_BEDROCK_BUDGET"
    public static let apiURLKey = "USAGER_BEDROCK_API_URL"
    public static let cloudWatchAPIURLKey = "USAGER_BEDROCK_CLOUDWATCH_API_URL"
    public static let profileKey = "AWS_PROFILE"
    public static let authModeKey = "USAGER_BEDROCK_AUTH_MODE"
