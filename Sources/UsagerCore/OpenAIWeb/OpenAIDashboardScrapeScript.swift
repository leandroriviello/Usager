...
let openAIDashboardScrapeScript = """
    ...
    (() => {
      ...
      const usageBreakdownJSON = (() => {
        try {
          if (window.__usagerUsageBreakdownJSON) return window.__usagerUsageBreakdownJSON;
          ...
          window.__usagerUsageBreakdownJSON = json;
          window.__usagerUsageBreakdownDebug = json ? null : JSON.stringify(debug);
          return json;
        } catch {
          return null;
        }
      ...
      const usageBreakdownDebug = (() => {
        try {
          return window.__usagerUsageBreakdownDebug || null;
        } catch {
          return null;
        }
      })();
      ...
      try {
        ...
        if (header) {
          ...
          if (rows.length === 0 && !window.__usagerDidScrollToCredits) {
            window.__usagerDidScrollToCredits = true;
        ...
        } else if (rows.length === 0 && !window.__usagerDidScrollToCredits && scrollHeight > viewportHeight * 1.5) {
          rows = allTableRows();
          if (rows.length > 0) {
            creditsHeaderPresent = true;
        ...
        if (rows.length === 0 && !window.__usagerDidScrollToCredits && scrollHeight > viewportHeight * 1.5) {
