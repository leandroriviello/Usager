...
public enum BrowserCookieAccessGate {
    ...
    private static let log = UsagerLog.logger(LogCategories.browserCookieGate)
    @TaskLocal private static var explicitRetryScope: ExplicitRetryScope?

    static let allowTestCookieAccessEnvironmentKey = "USAGER_ALLOW_TEST_BROWSER_COOKIE_ACCESS"
