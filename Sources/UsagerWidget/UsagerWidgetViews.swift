...
struct UsagerUsageWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: UsagerWidgetEntry
...
struct UsagerHistoryWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: UsagerWidgetEntry
...
struct UsagerCompactWidgetView: View {
...
struct UsagerSwitcherWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: UsagerSwitcherEntry
